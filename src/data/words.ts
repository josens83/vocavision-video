    ...
    words: [
      {
        ...
        koreanPron: "심텀 (강세: 심)",
        stress: "심",
        rhymeCaption: "A symptom whispers from the bottom — catch it early, or face the problem.",
        rhymeCaptionKo: "증상은 깊은 곳에서 속삭인다 — 일찍 잡아라, 아니면 문제에 직면한다.",
      ...
      },
      {
        ...
        stress: "노",
        rhymeCaption: "A diagnosis shows what no one knows — through every clue, the answer grows.",
        rhymeCaptionKo: "진단은 아무도 모르는 것을 보여준다 — 모든 단서를 통해, 답이 자라난다.",
      ...
      },
      {
        ...
        stress: "크로",
        rhymeCaption: "Chronic pain runs through the clock sonic — time is the enemy, never ironic.",
        rhymeCaptionKo: "만성 통증은 시계 소리처럼 흐른다 — 시간이 적이다, 결코 아이러니가 아니다.",
