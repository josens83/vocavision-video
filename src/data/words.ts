  ...
  },
  {
    ...
    words: [
      ...
      },
      {
        word: "underdog",
        meaning: "약체, 열세; 약자",
        pronunciation: "/ˈʌndərdɒɡ/",
        koreanPron: "언더독 (강세: 언)",
        stress: "언",
        rhymeCaption: "The underdog fights through the fog — from the bottom up, they outrun the top dog.",
        rhymeCaptionKo: "약자는 안개 속을 뚫고 싸운다 — 바닥에서 올라와 강자를 추월한다.",
        rhymeImageUrl: "https://sfqzlrsvrszdlusntdky.supabase.co/storage/v1/object/public/word-images/visuals/underdog-rhyme-1771408301079.png",
        example: "The appeal of the underdog story lies in its universal message: that determination, teamwork, and belief can overcome seemingly insurmountable odds.",
        exampleKo: "약자의 역전 이야기가 매력적인 이유는 보편적 메시지에 있다: 결단력, 팀워크, 믿음이 극복 불가능해 보이는 역경을 이길 수 있다는 것.",
      },
      {
        word: "MVP",
