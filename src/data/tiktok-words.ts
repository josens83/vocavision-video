...
export const TIKTOK_WORDS: TikTokWord[] = [
  ...
  },
  {
    ...
    meaningKo: "아무것도 느끼지 못하는 상태",
    meaningEn: "a complete lack of feeling or concern",
    hookLine1Ko: "슬프지도 않고 화나지도 않고",
    hookLine2Ko: "그냥... 아무것도",
    hookLine1En: "Not sad. Not angry.",
    hookLine2En: "Just... nothing.",
    scenes: [
      {
        imageUrl: "https://sfqzlrsvrszdlusntdky.supabase.co/storage/v1/object/public/word-images/stories/apathy/apathy-scene1.jpeg",
        captionKo: "알림이 쌓여도 손이 안 간다",
        captionEn: "Notifications pile up. Can't even reach.",
      },
      {
        imageUrl: "https://sfqzlrsvrszdlusntdky.supabase.co/storage/v1/object/public/word-images/stories/apathy/apathy-scene2.jpeg",
        captionKo: "무너져도 상관없다",
        captionEn: "Everything falls apart. Don't care.",
      },
      {
        imageUrl: "https://sfqzlrsvrszdlusntdky.supabase.co/storage/v1/object/public/word-images/stories/apathy/apathy-scene3.jpeg",
        captionKo: "아무것도 느끼지 못하는 게 제일 무섭다",
        captionEn: "Feeling nothing is the scariest feeling.",
      },
    ],
    bridgeKo: "이 상태를 설명하는\n단어가 있어",
    bridgeEn: "There's a word\nfor this emptiness.",
    ctaKo: "지금 이 상태인 사람? 👇",
    ctaEn: "Are you in this state right now? 👇",
  },
  {
    id: "stagnation",
    word: "stagnation",
    pronunciation: "/stæɡˈneɪʃən/",
    meaningKo: "아무것도 변하지 않는 정체 상태",
    meaningEn: "a state where nothing changes or progresses",
    hookLine1Ko: "쉬고 있는 게 아니야",
    hookLine2Ko: "멈춰 있는 거야",
    hookLine1En: "You're not resting.",
    hookLine2En: "You're stuck.",
    scenes: [
      {
        imageUrl: "https://sfqzlrsvrszdlusntdky.supabase.co/storage/v1/object/public/word-images/stories/stagnation/stagnation-scene1.jpeg",
        captionKo: "같은 길, 같은 얼굴, 같은 하루",
        captionEn: "Same route. Same face. Same day.",
      },
      {
        imageUrl: "https://sfqzlrsvrszdlusntdky.supabase.co/storage/v1/object/public/word-images/stories/stagnation/stagnation-scene2.jpeg",
        captionKo: "달만 바뀌고 나는 그대로",
        captionEn: "Months pass. Nothing else does.",
      },
      {
        imageUrl: "https://sfqzlrsvrszdlusntdky.supabase.co/storage/v1/object/public/word-images/stories/stagnation/stagnation-scene3.png",
        captionKo: "이게 너의 미래야",
        captionEn: "This is your future if nothing changes.",
      },
    ],
    bridgeKo: "이 상태를 부르는\n단어가 있어",
    bridgeEn: "There's a word\nfor being stuck.",
    ctaKo: "지금 멈춰 있는 사람? 👇",
    ctaEn: "Are you stuck right now? 👇",
  },
];
