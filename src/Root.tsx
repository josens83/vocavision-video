...
export const RemotionRoot: React.FC = () => {
  return (
    <>
      ...
      />
      <Composition
        id="TikTokShort-vindication-ko"
        component={TikTokShort}
        durationInFrames={600}
        fps={30}
        width={1080}
        height={1920}
        defaultProps={{ wordIndex: 2, lang: 'ko' as const }}
      />
      <Composition
        id="TikTokShort-vindication-en"
        component={TikTokShort}
        durationInFrames={600}
        fps={30}
        width={1080}
        height={1920}
        defaultProps={{ wordIndex: 2, lang: 'en' as const }}
      />
      <Composition
        id="TikTokShort-complacency-ko"
        component={TikTokShort}
        durationInFrames={600}
        fps={30}
        width={1080}
        height={1920}
        defaultProps={{ wordIndex: 3, lang: 'ko' as const }}
      />
      <Composition
        id="TikTokShort-complacency-en"
        component={TikTokShort}
        durationInFrames={600}
        fps={30}
        width={1080}
      ...
      />
      <Composition
        id="TikTokShort-apathy-ko"
        component={TikTokShort}
        durationInFrames={600}
        fps={30}
        width={1080}
        height={1920}
        defaultProps={{ wordIndex: 6, lang: 'ko' as const }}
      />
      <Composition
        id="TikTokShort-apathy-en"
        component={TikTokShort}
        durationInFrames={600}
        fps={30}
        width={1080}
        height={1920}
        defaultProps={{ wordIndex: 6, lang: 'en' as const }}
      />
      <Composition
        id="TikTokShort-stagnation-ko"
        component={TikTokShort}
        durationInFrames={600}
        fps={30}
        width={1080}
        height={1920}
        defaultProps={{ wordIndex: 7, lang: 'ko' as const }}
      />
      <Composition
        id="TikTokShort-stagnation-en"
        component={TikTokShort}
        durationInFrames={600}
        fps={30}
        width={1080}
        height={1920}
        defaultProps={{ wordIndex: 7, lang: 'en' as const }}
      />
      ...
      {/* set-046 EN: symptom, diagnosis, chronic */}
      <Composition
        id="WordShort-set-046-en"
        component={WordShort}
        durationInFrames={780}
        fps={VIDEO.PORTRAIT.fps}
        width={VIDEO.PORTRAIT.width}
